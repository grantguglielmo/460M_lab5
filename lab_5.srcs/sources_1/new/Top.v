...
Snake sk(Key, BTNS, CLK, frameClk, Xpos, Ypos, drawSnake, drawFood);        //Determine if snake at current pixel, and control snake
vgaController vga(CLK, pixelClk, sw, drawSnake, drawFood, hsync, vsync, R, G, B, Xpos, Ypos);      //Draw pixels
